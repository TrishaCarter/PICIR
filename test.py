...
# print("\nUNION/STRUCT TEST\n")
# TEST_STRUCT_NAME = "test_struct"
# TEST_STRUCT_INPUT_VARIABLES = ["#1", "#2"]  # argc, argv
...
# TEST_STRUCT_INCLUDED_LIBRARIES = ["#include <stdio.h>"]


# TEST_STRUCT_FUNCTION = Function(TEST_STRUCT_NAME, TEST_STRUCT_INPUT_VARIABLES, TEST_STRUCT_TOKENS)

# COMPILED_STRUCT_CODE = IRToCDecompiler(TEST_STRUCT_FUNCTION, TEST_STRUCT_TYPES, TEST_STRUCT_INCLUDED_LIBRARIES, {}).generate_c_code()
